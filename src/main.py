      ...
      "articles": [
        {
          ...
          "tw_sources": [{"name": "經濟日報", "url": "https://..."}, {"name": "工商時報", "url": "https://..."}]
        },
        {
          "format": "B",
          "title": "事件名稱（持續追蹤）",
          ...
          "sources": [{"name": "來源名稱", "url": "https://..."}],
          "tw_sources": [{"name": "台灣媒體名稱", "url": "https://..."}]
        },
        {
          "format": "C",
          "title": "標題",
...
- **tw_sources（台灣延伸閱讀）**：每則新聞如果在 RSS 中有對應的台灣媒體報導（經濟日報、工商時報、中央社、自由財經、MoneyDJ），就把這些台灣連結放到 tw_sources 欄位。如果 RSS 裡沒有直接對應的台灣報導，則省略 tw_sources 欄位（不要硬湊）。台灣來源 URL 必須是 RSS 中實際出現的文章連結。
"""
